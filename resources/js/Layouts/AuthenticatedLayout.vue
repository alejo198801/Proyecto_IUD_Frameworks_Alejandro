            ...
            <nav class="bg-white border-b border-gray-100">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <NavLink :href="route('grafico')" :active="route().current('grafico')">
                                    Graficos
                                </NavLink>
                            </div>
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                ...
                <div :class="{ block: showingNavigationDropdown, hidden: !showingNavigationDropdown }" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <div class="pt-2 pb-3 space-y-1">
                            <ResponsiveNavLink :href="route('cursos.index')" :active="route().current('cursos.index')">
                                Cursos
                            </ResponsiveNavLink>
                        </div>
                        <div class="pt-2 pb-3 space-y-1">
                            <ResponsiveNavLink :href="route('estudiantes.index')"
                                :active="route().current('estudiantes.index')">
                                Estudiantes
                            </ResponsiveNavLink>
                        </div>
                        <div class="pt-2 pb-3 space-y-1">
                            <ResponsiveNavLink :href="route('grafico')" :active="route().current('grafico')">
                                Graficos
                            </ResponsiveNavLink>
                        </div>
                        <div class="pt-2 pb-3 space-y-1">
